; file_search collects all files containing a specified string in the desired directory
...
alt='*rad_'+ altitude + '*'  ; append the relevant parts. * is necessary so that the file_search function knows to look for whatever is contained within the asterisks
